          ...
          <div className="flex flex-col sm:flex-row sm:items-start">
            ...
            <div>
              <CalendarPrimitive
                ...
                initialFocus
                classNames={{
                  months: "flex flex-row gap-4", // jarak antarmonth
                  caption_label: "text-gray-800",
                  nav_button: "text-gray-600 hover:bg-gray-100",
                  head_cell: "text-gray-500",
                  table: "mt-2",
                  day: "h-9 w-9 rounded-md text-gray-800 hover:bg-[#EEF0E8]",
                  day_selected:
                    "bg-[#6E8649] text-white hover:bg-[#5c7b3f] focus:bg-[#5c7b3f]",
                  day_range_middle: "bg-[#EEF0E8] text-gray-800",
                  day_today: "ring-1 ring-[#6E8649]",
          ...
          <div className="flex flex-col overflow-x-auto sm:flex-row sm:items-start">
            ...
            <div className="overflow-x-auto">
              <CalendarPrimitive
                ...
                initialFocus
                classNames={{
                  months: "flex flex-row gap-4 overflow-x-auto",
                  caption_label: "text-gray-800",
                  nav_button: "text-gray-600 hover:bg-gray-100",
                  head_cell: "text-gray-500",
                  table: "mt-2",
                  ...
                  day_range_middle: "bg-[#EEF0E8] text-gray-800",
                  day_today:
                    "ring-1 ring-[#6E8649] focus:ring-0 focus:outline-none",
                  day_outside: "text-gray-300",
                }}
                {...props}
              />
              ...
              <div className="border-t border-gray-200 p-3 sm:flex sm:items-center sm:justify-between ">
                ...
                <div className="mt-2 flex items-center justify-end gap-x-2  border-gray-200 pt-3">
                  <button
                    type="button"
                    onClick={onCancel}
                    className="inline-flex h-9 items-center justify-center rounded-md border border-gray-300 bg-white px-4 text-sm text-gray-700 hover:bg-gray-100"
                  >
                    {translations?.cancel ?? "Batal"}
                  </button>
                  <button
                    type="button"
                    onClick={onApply}
                    className="inline-flex h-9 items-center justify-center rounded-md bg-[#6E8649] px-4 text-sm font-medium text-white hover:bg-[#5c7b3f]"
                  >
                    {translations?.apply ?? "Ya, Simpan"}
                  </button>
                </div>
