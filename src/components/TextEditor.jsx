...
const Toolbar = ({ editor, onFotoClick }) => {
  ...
  return (
    <div className="flex items-center justify-center gap-1 p-2 border-b border-gray-200 bg-white rounded-t-lg">
      <button type="button" onClick={onFotoClick} className={btn(false)}>
        <ImageIcon size={18} />
      </button>
